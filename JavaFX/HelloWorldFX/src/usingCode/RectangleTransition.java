...
public class RectangleTransition extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Rectangle rectangle = new Rectangle(0, 0, 250, 250);
...
//        ParallelTransition transition = new ParallelTransition(rectangle, translate, fill, rotate, scale);
        ParallelTransition transition = new ParallelTransition(rectangle, translate);
